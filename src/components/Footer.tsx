        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-display font-bold text-xl text-white">Crédito360</span>
            </div>
            <p className="text-gray-400 mb-4 text-sm">
              Marketplace de crédito inteligente via Open Finance. Conectamos pessoas a melhores oportunidades financeiras.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#" className="hover:text-white">Open Finance</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li><a href="#partners" className="hover:text-white">Parceiros</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; 2025 Crédito360. Todos os direitos reservados.
            </p>
